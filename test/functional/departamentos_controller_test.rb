...
class DepartamentosControllerTest < ActionController::TestCase
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post :create, departamento: { abreviatura: @departamento.abreviatura, andar: @departamento.andar, nome: @departamento.nome }
    end
  ...
  test "should update departamento" do
    put :update, id: @departamento, departamento: { abreviatura: @departamento.abreviatura, andar: @departamento.andar, nome: @departamento.nome }
    assert_redirected_to departamento_path(assigns(:departamento))
  end
